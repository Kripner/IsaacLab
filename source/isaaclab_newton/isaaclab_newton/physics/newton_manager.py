...
class NewtonManager(PhysicsManager):
    ...
    def instantiate_builder_from_stage(cls):
        ...
        if not env_paths:
            ...
            # The prototype includes env_0's world-space positions.
            ...
            # Compute env_0's world transform so we can compute deltas for other envs.
            ...
            # env_0's positions are baked into the prototype, so we apply the
            # delta from env_0 to env_N as the world offset.
